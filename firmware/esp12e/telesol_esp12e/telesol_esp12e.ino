...
#include "config.h"
#include "sensors/radar_ld2420.h"
#include "sensors/tof_vl53.h"
...
void pushToBackend() {
    ...
    // Radar
    JsonObject radar = sensors.createNestedObject("radar");
    ...
    // ToF
    JsonObject tof = sensors.createNestedObject("tof");
    ...
    JsonObject audio = sensors.createNestedObject("audio");
    ...
    if (httpCode == 200 || httpCode == 201) {
        ...
        if (deserializeJson(respDoc, response) == DeserializationError::Ok) {
            ...
            if (respDoc.containsKey("phone_data")) {
